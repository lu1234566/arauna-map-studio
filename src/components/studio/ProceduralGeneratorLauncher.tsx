...
export function ProceduralGeneratorLauncher() {
  return (
    <Link
      to="/generator"
      ...
      title="Gerar layouts automaticamente usando apenas Padrões e Smart Paths verificados"
    >
      <Sparkles className="size-3.5" /> Gerador procedural
    </Link>
  );
}
